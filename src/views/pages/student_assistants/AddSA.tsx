...
const DialogAddSA = ({ refreshData }) => {
  ...
  const onSubmit = async (data: SAData) => {
    ...
    try {
      const response = await fetch('/api/admin/student_assistant/add', {
        method: 'POST',
        headers: {
      ...
      toast.success('Student Assistant Added Successfully')
      handleClose()
    } catch (error) {
      toast.error('Student Assistant Added Successfully')
    }
  }
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            ...
            <Box sx={{ mb: 8, textAlign: 'center' }}>
              ...
              <Typography variant='body2'>Fill Student Assistant Data</Typography>
            </Box>
