...
const DialogAddDepartment = ({ refreshData }) => {
  // ** States
  ...
  const onSubmit = async (data: DepartmentsData) => {
    axios.post(`/api/departments/add`, data)
      .then(() => {
      ...
      .catch((error) => {
        console.error(error)
        toast.error('Department Adding Failed')
      })
  }
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              ...
              <Box sx={{ mb: 8, textAlign: 'center' }}>
                ...
                <Typography variant='body2'>Add new department.</Typography>
              </Box>
...
export default DialogAddDepartment
