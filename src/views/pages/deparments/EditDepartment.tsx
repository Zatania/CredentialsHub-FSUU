...
const DialogEditDepartment = ({ department, refreshData }) => {
  // ** States
  ...
  const onSubmit = async (data: CredentialsData) => {
    ...
    axios.put(`/api/departments/edit`, data)
      .then(() => {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              ...
              <Box sx={{ mb: 8, textAlign: 'center' }}>
                ...
                <Typography variant='body2'>Change the name of the department.</Typography>
              </Box>
...
export default DialogEditDepartment
